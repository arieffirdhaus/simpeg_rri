package com.devteam.mobile.simpegrri.ui.riwayat;
...
public class Kepangkatan extends AppCompatActivity {
...
//    PrefManager prefManager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.riwayat_kepangkatan);
        toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("Riwayat Kepangkatan");
